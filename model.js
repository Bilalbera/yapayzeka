...
Bu açıklamada kod üretmedim.`;
  ...
  **Temel akış:**
  1. Kullanıcı, botun beklediği biçimde bir mesaj gönderir.
  2. Bot mesajı algılar ve ${truncate(subtopic, 80)} ile ilgili kısmı ayrıştırır.
  3. Gerekli izin ve koşul kontrolleri yapılır.
  4. Bot, uygun işlemi çalıştırır ve sonucu kullanıcıya gönderir.
